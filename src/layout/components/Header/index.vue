...
<script lang="ts">
  ...
  export default defineComponent({
    ...
    setup(props) {
      const { getNavTheme, getHeaderSetting, getMenuSetting, getCrumbsSetting } =
        useProjectSetting();
      ...
      const generator: any = (routerMap: Array<RouteRecordNormalized>) => {
        return routerMap.map((item: RouteRecordNormalized) => {
          const currentMenu = {
            ...omit(item, 'props'),
