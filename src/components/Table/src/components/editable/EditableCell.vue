  ...
  export default defineComponent({
    ...
    setup(props) {
      ...
      const getComponentProps = computed(() => {
        ...
        const editComponent = props.column?.editComponent ?? 'NInput';
        const component = unref(getComponent);
      ...
      const getValues = computed(() => {
        ...
        const value = unref(defaultValueRef);
      ...
      async function handleSubmit(needEmit = true, valid = true) {
        ...
        const old = unref(defaultValueRef)
        ...
        needEmit && table.emit?.('edit-end', { record, index, key, value, old });
        isEdit.value = false;
      }
